...
public class DnnServerModel implements Serializable {
	...
	public DnnServerModel(DnnModelParameters modelParameters){
		mWeightsData = new HashMap<>();
		mNumberOfTrainingObjects = loadTrainingData();
		createModel(modelParameters);
	}

	public DnnServerModel(DnnModelDescriptor modelDescriptor){
		mWeightsData = new HashMap<>();
